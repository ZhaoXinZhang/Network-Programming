...
sc.columns = [ 'Name', 'English', 'Math','C','Python','Mid','Final']
sc['mean']=sc.mean(axis=1)
sc['CP']=(sc['C']+sc['Python'])/2
print(sc)
...
sc_CP=sc[sc['CP']>=80]
sc_CP_table=DataFrame({'Name':sc_CP['Name'],'C':sc_CP['C'],'Python':sc_CP['Python'],'meanScore':sc_CP['CP']})
